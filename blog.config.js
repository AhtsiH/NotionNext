...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '喵？,喵！,猫猫躲起来了。',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-umber-pi.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'xinghegaoxuan@gmail.com', // 邮箱地址 例如mail@tangly1024.com
